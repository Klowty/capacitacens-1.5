...
module.exports = {
    async store(req, res) {
        ...
        if (verificaUser) {
            return res.json({
                error: 'Erro: um usuário já foi cadastrado com esse email',
            });
        }
    ...
    async show(req, res) {
        ...
        if (!user) {
            return res.json({
                error: 'Não há nenhum usuário com o id especificado',
            });
        }
    ...
    async destroy(req, res) {
        ...
        return res.json({
            error: 'Não há nenhum  registro com o id especificado!',
        });
    },
};
